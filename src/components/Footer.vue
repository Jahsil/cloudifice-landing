<template>
  <footer class="bg-gray-900 text-gray-400 py-16">
    <div class="container mx-auto px-6">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div>
          <div class="flex items-center space-x-2 mb-6">
            ...
            <span class="text-2xl font-bold text-white">Cloudifice</span>
          </div>
          <p class="mb-6">
            The most robust distributed file storage solution for modern teams.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-3">
            ...
            <li>
              <a href="#" class="hover:text-white transition">Releases</a>
            </li>
      ...
      >
        <p>© 2023 Cloudifice. All rights reserved.</p>
